...
(function (ct, gt) {
  (function (_, p) {
    ...
    return function (B) {
      ...
      return p.m = B, p.c = _, p.d = function (P, N, k) {
        p.o(P, N) || Object.defineProperty(P, N, {
          configurable: !1,
          enumerable: !0,
          get: k
        })
      ...
      function l() {
        ...
        var i = a[0];
        if (typeof i.blotName != "string" && typeof i.attrName != "string") throw new N("Invalid definition");
        if (i.blotName === "abstract") throw new N("Cannot register abstract class");
        if (c[i.blotName || i.attrName] = i, typeof i.keyName == "string") k[i.keyName] = i;
      ...
      c.prototype.insert = function (o, t) {
        ...
        if (o = k(!0, {}, o), typeof e == "object") {
          if (typeof o.delete == "number" && typeof e.delete == "number") return this.ops[t - 1] = {
            delete: e.delete + o.delete
          }, this;
          ...
          if (N(o.attributes, e.attributes)) {
            if (typeof o.insert == "string" && typeof e.insert == "string") return this.ops[t - 1] = {
              insert: e.insert + o.insert
            }, typeof o.attributes == "object" && (this.ops[t - 1].attributes = o.attributes), this;
            if (typeof o.retain == "number" && typeof e.retain == "number") return this.ops[t - 1] = {
              retain: e.retain + o.retain
            }, typeof o.attributes == "object" && (this.ops[t - 1].attributes = o.attributes), this
          }
        }
        ...
        var e = [this, o].map(function (i) {
            return i.map(function (f) {
              if (f.insert != null) return typeof f.insert == "string" ? f.insert : y;
              var n = i === o ? "on" : "with";
...
`;
        ...
        for (var e = m.iterator(this.ops), u = m.iterator(o.ops), l = new c; e.hasNext() || u.hasNext();)
          if (e.peekType() === "insert" && (t || u.peekType() !== "insert")) l.retain(m.length(e.next()));
      ...
      var p = Object.prototype.hasOwnProperty,
        ...
        y = function (e) {
          ...
          var u = p.call(e, "constructor"),
            l = e.constructor && e.constructor.prototype && p.call(e.constructor.prototype, "isPrototypeOf");
...
`)) {
              ...
              } else N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "insertAt", this).call(this, T, q, D)
            }
          }]), d
        }(t.default.Embed);
...
`, v(this))), this.cache.delta
          ...
          key: "insertAt",
          value: function (T, q, D) {
            if (D != null) return N(d.prototype.__proto__ || Object.getPrototypeOf(d.prototype), "insertAt", this).call(this, T, q, D);
            if (q.length !== 0) {
              var C = q.split(`
`),
                Z = C.shift();
      ...
      function v(h) {
        ...
        return h == null || (typeof h.formats == "function" && (d = (0, m.default)(d, h.formats())), h.parent == null || h.parent.blotName == "scroll" || h.parent.statics.scope !== h.statics.scope) ? d : v(h.parent, d)
      }
        ...
        T = function () {
          k(I, null, [{
            ...
            value: function (O, S) {
              ...
              } else this.imports[O] != null && !F && E.warn("Overwriting " + O + " with", S), this.imports[O] = S, (O.startsWith("blots/") || O.startsWith("formats/")) && S.blotName !== "abstract" ? r.default.register(S) : O.startsWith("modules") && typeof S.register == "function" && S.register()
            }
          }]);
          ...
          function I(R) {
            ...
            if (d(this, I), this.options = q(R, S), this.container = this.options.container, this.container == null) return E.error("Invalid Quill container", R);
          ...
          return k(I, [{
            ...
            value: function (O, S) {
              var L = this,
                F = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : e.default.sources.API;
              return D.call(this, function () {
                var M = L.getSelection(!0),
                  x = new y.default;
                if (M == null) return x;
                if (r.default.query(O, r.default.Scope.BLOCK)) x = L.editor.formatLine(M.index, M.length, h({}, O, S));
                else {
            ...
            value: function () {
              var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0,
                S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.getLength() - O,
                L = C(O, S),
                F = N(L, 2);
            ...
            key: "getFormat",
            value: function () {
              var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.getSelection(!0),
            ...
            value: function () {
              var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0,
                S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Number.MAX_VALUE;
            ...
            value: function (O, S, L) {
              var F = this,
                M = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : I.sources.API;
              return D.call(this, function () {
            ...
            value: function (O) {
              var S = this,
                L = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : e.default.sources.API;
              return D.call(this, function () {
                O = new y.default(O);
                var F = S.getLength(),
...
` && (S.editor.deleteText(S.getLength() - 1, 1), x.delete(1));
            ...
            key: "setText",
            value: function (O) {
              var S = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : e.default.sources.API,
            ...
            key: "update",
            value: function () {
              var O = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : e.default.sources.USER,
      ...
      function q(I, R) {
        if (R = (0, s.default)(!0, {
          ...
          }, R), !R.theme || R.theme === T.DEFAULTS.theme) R.theme = w.default;
        ...
        }), R = (0, s.default)(!0, {}, T.DEFAULTS, {
          modules: L
        }, O, R), ["bounds", "container", "scrollingContainer"].forEach(function (F) {
      ...
      function D(I, R, O, S) {
        if (this.options.strict && !this.isEnabled() && R === e.default.sources.USER) return new y.default;
        ...
        return P(r, [{
          ...
          value: function (f, n, s, A) {
            if (r.compare(this.statics.blotName, s) < 0 && c.default.query(s, c.default.Scope.BLOT)) {
              ...
              A && g.wrap(s, A)
            } else N(r.prototype.__proto__ || Object.getPrototypeOf(r.prototype), "formatAt", this).call(this, f, n, s, A)
          }
        }, {
          key: "optimize",
          value: function (f) {
      ...
      l.allowedChildren = [l, c.default.Embed, m.default], l.order = ["cursor", "inline", "underline", "strike", "italic", "bold", "script", "link", "code"], _.default = l
    }, function (B, _, p) {
      Object.defineProperty(_, "__esModule", {
        value: !0
      });
      ...
      function u(i, f) {
        ...
        }), f && (Object.setPrototypeOf ? Object.setPrototypeOf(i, f) : i.__proto__ = f)
      }
        ...
        return P(f, [{
          ...
          value: function (s) {
            ...
            (this.listeners[s.type] || []).forEach(function (w) {
              var v = w.node,
                h = w.handler;
              (s.target === v || v.contains(s.target)) && h.apply(void 0, [s].concat(g))
            })
          }
        }, {
          key: "listenDOM",
          value: function (s, A, g) {
            this.listeners[s] || (this.listeners[s] = []), this.listeners[s].push({
              node: A,
              handler: g
            })
          }
      ...
      function o(t, e, u) {
        ...
        if (k(t)) return k(e) ? (t = P.call(t), e = P.call(e), m(t, e, u)) : !1;
        if (c(t)) {
      ...
      var P = function () {
          function b(w, v) {
            var h = [],
              ...
              T = void 0;
            try {
              for (var q = w[Symbol.iterator](), D; !(d = (D = q.next()).done) && (h.push(D.value), !(v && h.length === v)); d = !0);
            } catch (C) {
              E = !0, T = C
            } finally {
              try {
...
`) ? h : h + 1
          ...
          value: function (h) {
            ...
            if (d) return this.domNode.textContent.slice(0, h).lastIndexOf(`
`);
...
`));
            ...
            value: function (O) {
              ...
              } else this.delta = this.getDelta(), (!O || !(0, w.default)(F.compose(O), this.delta)) && (O = F.diff(this.delta, L));
              return O
            }
          }]), I
        }();
      ...
      function Z(I) {
        return I.reduce(function (R, O) {
          if (O.insert === 1) {
            ...
            return delete S.image, R.insert({
              image: O.attributes.image
            }, S)
          }
...
`);
      ...
      var n = (0, a.default)("quill:selection"),
        ...
        A = function () {
          function b(w, v) {
            var h = this;
            f(this, b), this.emitter = v, this.scroll = w, this.composing = !1, this.mouseDown = !1, this.root = this.scroll.domNode, this.cursor = m.default.create("cursor", this), this.lastRange = this.savedRange = new s(0, 0), this.handleComposition(), this.handleDragging(), this.emitter.listenDOM("selectionchange", document, function () {
          ...
          return N(b, [{
            ...
            value: function () {
              ...
              this.root.addEventListener("compositionstart", function () {
                ...
                if (v.composing = !1, v.cursor.parent) {
                  ...
                  if (!h) return;
                  setTimeout(function () {
                    v.setNativeRange(h.startNode, h.startOffset, h.endNode, h.endOffset)
                  }, 1)
                }
              })
            }
            ...
            value: function (v, h) {
              if (!(this.scroll.whitelist != null && !this.scroll.whitelist[v])) {
                ...
                if (!(d == null || !d.native.collapsed || m.default.query(v, m.default.Scope.BLOCK))) {
                  ...
                  this.cursor.format(v, h), this.scroll.optimize(), this.setNativeRange(this.cursor.textNode, this.cursor.textNode.data.length), this.update()
                }
              }
            }
          }, {
            ...
            key: "normalizeNative",
            value: function (v) {
              if (!g(this.root, v.startContainer) || !v.collapsed && !g(this.root, v.endContainer)) return null;
              var h = {
                start: {
              ...
              return [h.start, h.end].forEach(function (d) {
                for (var E = d.node, T = d.offset; !(E instanceof Text) && E.childNodes.length > 0;)
                  ...
                  else if (E.childNodes.length === T) E = E.lastChild, T = E instanceof Text ? E.data.length : E.childNodes.length + 1;
                else break;
                d.node = E, d.offset = T
              }), h
            }
              ...
              if (h != null) {
                ...
                if (d != null) {
                  ...
                  if (!(D == null || C == null)) {
                    ...
                    d.top < R.top ? v.scrollTop -= R.top - d.top : d.bottom > R.bottom && (v.scrollTop += d.bottom - R.bottom)
                  }
                }
              }
            }
            ...
            key: "setNativeRange",
            value: function (v, h) {
              var d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : v,
                E = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : h,
                T = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !1;
              if (n.info("setNativeRange", v, h, d, E), !(v != null && (this.root.parentNode == null || v.parentNode == null || d.parentNode == null))) {
                var q = document.getSelection();
                if (q != null)
                  if (v != null) {
                    this.hasFocus() || this.root.focus();
                    var D = (this.getNativeRange() || {}).native;
                    if (D == null || T || v !== D.startContainer || h !== D.startOffset || d !== D.endContainer || E !== D.endOffset) {
                      v.tagName == "BR" && (h = [].indexOf.call(v.parentNode.childNodes, v), v = v.parentNode), d.tagName == "BR" && (E = [].indexOf.call(d.parentNode.childNodes, d), d = d.parentNode);
                      var C = document.createRange();
                      C.setStart(v, h), C.setEnd(d, E), q.removeAllRanges(), q.addRange(C)
                    }
            ...
            value: function (v) {
              var h = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1,
                d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : u.default.sources.API;
              if (typeof h == "string" && (d = h, h = !1), n.info("setRange", v), v != null) {
            ...
            key: "update",
            value: function () {
              var v = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : u.default.sources.USER,
                h = this.lastRange,
                d = this.getRange(),
                E = P(d, 2),
                T = E[0],
              ...
              if (this.lastRange = T, this.lastRange != null && (this.savedRange = this.lastRange), !(0, t.default)(h, this.lastRange)) {
                ...
                var C = [u.default.events.SELECTION_CHANGE, (0, c.default)(this.lastRange), (0, c.default)(h), v];
                if ((D = this.emitter).emit.apply(D, [u.default.events.EDITOR_CHANGE].concat(C)), v !== u.default.sources.SILENT) {
                  var Z;
      ...
      m.prototype.hasNext = function () {
        ...
        if (c) {
          var o = this.offset,
            t = k.length(c);
          if (y >= t - o ? (y = t - o, this.index += 1, this.offset = 0) : this.offset += y, typeof c.delete == "number") return {
            delete: y
          };
          var e = {};
      ...
      var p = function () {
        ...
        function y(l, a, r, i, f) {
          ...
          function g(b, w) {
            ...
            else if (P(b, m)) v = new m(function (R, O) {
              b.then(function (S) {
                R(g(S, w - 1))
              }, function (S) {
                O(g(S, w - 1))
            ...
            else if (y.__isRegExp(b)) v = new RegExp(b.source, u(b)), b.lastIndex && (v.lastIndex = b.lastIndex);
            else if (y.__isDate(b)) v = new Date(b.getTime());
            else {
              if (A && Buffer.isBuffer(b)) return Buffer.allocUnsafe ? v = Buffer.allocUnsafe(b.length) : v = new Buffer(b.length), b.copy(v), v;
              P(b, Error) ? v = Object.create(b) : typeof i > "u" ? (h = Object.getPrototypeOf(b), v = Object.create(h)) : (v = Object.create(i), h = i)
            }
            if (a) {
              var d = n.indexOf(b);
              if (d != -1) return s[d];
            ...
            for (var E in b) {
              var T;
              h && (T = Object.getOwnPropertyDescriptor(h, E)), !(T && T.set == null) && (v[E] = g(b[E], w - 1))
            }
            if (Object.getOwnPropertySymbols)
              for (var q = Object.getOwnPropertySymbols(b), E = 0; E < q.length; E++) {
                var D = q[E],
                  C = Object.getOwnPropertyDescriptor(b, D);
                C && !C.enumerable && !f || (v[D] = g(b[D], w - 1), C.enumerable || Object.defineProperty(v, D, {
                  enumerable: !1
                }))
              }
            if (f)
              for (var Z = Object.getOwnPropertyNames(b), E = 0; E < Z.length; E++) {
                ...
                C && C.enumerable || (v[I] = g(b[I], w - 1), Object.defineProperty(v, I, {
                  enumerable: !1
                }))
              }
            return v
      ...
      function g(v, h) {
        ...
        }), h && (Object.setPrototypeOf ? Object.setPrototypeOf(v, h) : v.__proto__ = h)
      }
      ...
      var w = function (v) {
        ...
        function h(d, E) {
          ...
          return T.emitter = E.emitter, Array.isArray(E.whitelist) && (T.whitelist = E.whitelist.reduce(function (q, D) {
            return q[D] = !0, q
          }, {})), T.domNode.addEventListener("DOMNodeInserted", function () {}), T.optimize(), T.enable(), T
        }
        return N(h, [{
          key: "batchStart",
          value: function () {
...
`) && (T = T.slice(0, -1)), D.insertAt(0, T, q)
              ...
              else k(h.prototype.__proto__ || Object.getPrototypeOf(h.prototype), "insertAt", this).call(this, E, T, q);
              this.optimize()
            }
          }
        }, {
          ...
          value: function () {
            var E = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0,
              T = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Number.MAX_VALUE,
              q = function D(C, Z, I) {
                var R = [],
                  O = I;
      ...
      function h(x, j, U) {
        return j in x ? Object.defineProperty(x, j, {
          value: U,
          enumerable: !0,
          configurable: !0,
          writable: !0
      ...
      function T(x, j) {
        ...
        }), j && (Object.setPrototypeOf ? Object.setPrototypeOf(x, j) : x.__proto__ = j)
      }
        ...
        C = function (x) {
          ...
          function j(U, H) {
            ...
            return V.bindings = {}, Object.keys(V.options.bindings).forEach(function (Y) {
              ...
              ctrlKey: null,
              altKey: null
            }, function () {}), /Firefox/i.test(navigator.userAgent) ? (V.addBinding({
          ...
          return k(j, [{
            ...
            value: function (H) {
              var V = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
                ...
                X = M(H);
              if (X == null || X.key == null) return q.warn("Attempted to add invalid keyboard binding", X);
              typeof V == "function" && (V = {
                handler: V
              }), typeof Y == "function" && (Y = {
                handler: Y
              }), X = (0, e.default)(X, V, Y), this.bindings[X.key] = this.bindings[X.key] || [], this.bindings[X.key].push(X)
            }
          }, {
            key: "listen",
            value: function () {
                    ...
                    if (!(Q == null || !H.quill.hasFocus())) {
                      var nt = H.quill.getLine(Q.index),
                        ...
                        dt = X.some(function (ot) {
                          if (ot.collapsed != null && ot.collapsed !== it.collapsed || ot.empty != null && ot.empty !== it.empty || ot.offset != null && ot.offset !== it.offset) return !1;
          ...
          "checklist enter": {
            ...
            handler: function (j) {
              var U = this.quill.getLine(j.index),
                ...
                V = H[0],
                Y = H[1],
                X = (0, e.default)({}, V.formats(), {
                  list: "checked"
                }),
                Q = new l.default().retain(j.index).insert(`
`, X).retain(V.length() - Y - 1).retain(1, {
                  list: "unchecked"
                });
          ...
          "header enter": {
            ...
            handler: function (j, U) {
              var H = this.quill.getLine(j.index),
                ...
                X = V[1],
                Q = new l.default().retain(j.index).insert(`
`, U.format).retain(Y.length() - X - 1).retain(1, {
                  header: null
                });
              this.quill.updateContents(Q, s.default.sources.USER), this.quill.setSelection(j.index + 1, s.default.sources.SILENT), this.quill.scrollIntoView()
            }
          ...
          "list autofill": {
            ...
            handler: function (j, U) {
              ...
              var rt = new l.default().retain(j.index - Q).delete(H + 1).retain(X.length() - 2 - Q).retain(1, {
                list: nt
              });
          ...
          "code exit": {
            ...
            handler: function (j) {
              var U = this.quill.getLine(j.index),
                ...
                V = H[0],
                Y = H[1],
                X = new l.default().retain(j.index + V.length() - Y - 2).retain(1, {
                  "code-block": null
                }).delete(1);
...
`);
      ...
      function M(x) {
        if (typeof x == "string" || typeof x == "number") return M({
          key: x
        });
      ...
      var a = function (r) {
        ...
        return k(i, [{
          ...
          key: "format",
          value: function (n, s) {
            if (this._length !== 0) return N(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "format", this).call(this, n, s);
            for (var A = this, g = 0; A != null && A.statics.scope !== y.default.Scope.BLOCK_BLOT;) g += A.offset(A.parent), A = A.parent;
          ...
          value: function () {
            if (!(this.selection.composing || this.parent == null)) {
              ...
              if (this.textNode.data !== i.CONTENTS) {
                ...
                this.next instanceof o.default ? (A = this.next.domNode, this.next.insertAt(0, v), this.textNode.data = i.CONTENTS) : (this.textNode.data = v, this.parent.insertBefore(y.default.create(this.textNode), this), this.textNode = document.createTextNode(i.CONTENTS), this.domNode.appendChild(this.textNode))
              }
      ...
      var e = function (l) {
        ...
        return P(a, [{
          key: "format",
          value: function (i, f) {
            if (i !== this.statics.blotName || !f) return N(a.prototype.__proto__ || Object.getPrototypeOf(a.prototype), "format", this).call(this, i, f);
      ...
      var P = p(1),
        N = function () {
          function k(m) {
            this.domNode = m, this.domNode[P.DATA_KEY] = {
              blot: this
            }
          }
          ...
          }, k.prototype.update = function (m, y) {}, k.prototype.wrap = function (m, y) {
            var c = typeof m == "string" ? P.create(m, y) : m;
          ...
          return P(i, [{
            ...
            value: function (n) {
              ...
              if (n === this.leftGuard)
                ...
                } else A = document.createTextNode(g), this.parent.insertBefore(m.default.create(A), this), s = {
                  startNode: A,
                  startOffset: g.length
                };
              else n === this.rightGuard && (this.next instanceof c.default ? (this.next.insertAt(0, g), s = {
      ...
      var a = function (f) {
        ...
        function n(s, A) {
          ...
          return g.lastRecorded = 0, g.ignoreChange = !1, g.clear(), g.quill.on(y.default.events.EDITOR_CHANGE, function (b, w, v, h) {
            b !== y.default.events.TEXT_CHANGE || g.ignoreChange || (!g.options.userOnly || h === y.default.sources.USER ? g.record(w, v) : g.transform(w))
          }), g.quill.keyboard.addBinding({
            key: "Z",
            shortKey: !0
          }, g.undo.bind(g)), g.quill.keyboard.addBinding({
            key: "Z",
            shortKey: !0,
            shiftKey: !0
          }, g.redo.bind(g)), /Win/i.test(navigator.platform) && g.quill.keyboard.addBinding({
            key: "Y",
            shortKey: !0
          }, g.redo.bind(g)), g
        }
...
`) : n.attributes != null ? Object.keys(n.attributes).some(function (s) {
          ...
          return P(L, [{
            ...
            value: function (M, x) {
              ...
              this.pickers = M.map(function (H) {
                if (H.classList.contains("ql-align")) return H.querySelector("option") == null && O(H, E), new n.default(H, x.align);
                ...
                } else return H.querySelector("option") == null && (H.classList.contains("ql-font") ? O(H, q) : H.classList.contains("ql-header") ? O(H, D) : H.classList.contains("ql-size") && O(H, C)), new A.default(H)
              });
              var U = function () {
                ...
                F == null && (F = document.createElement("input"), F.setAttribute("type", "file"), F.setAttribute("accept", "image/png, image/gif, image/jpeg, image/bmp, image/x-icon"), F.classList.add("ql-image"), F.addEventListener("change", function () {
                  if (F.files != null && F.files[0] != null) {
                    ...
                    M.onload = function (x) {
                      ...
                      L.quill.updateContents(new c.default().retain(j.index).delete(j.length).insert({
                        image: x.target.result
                      }), t.default.sources.USER), L.quill.setSelection(j.index + 1, t.default.sources.SILENT), F.value = ""
      ...
      var I = function (S) {
        ...
        return P(L, [{
          ...
          key: "edit",
          value: function () {
            var M = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "link",
      ...
      var P = function () {
        ...
        return N.prototype.append = function () {
          ...
          for (var y, c = this.iterator(); y = c();) {
            var o = y.length();
            if (k < o || m && k === o && (y.next == null || y.next.length() !== 0)) return [y, k];
            k -= o
          }
          return [null, 0]
          ...
          if (!(m <= 0))
            for (var c = this.find(k), o = c[0], t = c[1], e, u = k - t, l = this.iterator(o);
              (e = l()) && u < k + m;) {
              var a = e.length();
        ...
        c = function (o) {
          ...
          return t.prototype.detach = function () {
            ...
            for (var r = function (s, A) {
              ...
              if (n >= y) throw new Error("[Parchment] Maximum optimize iterations reached");
      ...
      var N = p(18),
        ...
        m = function (y) {
          ...
          return c.formats = function (o) {
            ...
            if (e == null || k.query(t, k.Scope.INLINE) != null) y.prototype.insertAt.call(this, o, t, e);
            else {
              var u = this.split(o),
                l = k.create(t, e);
      ...
      var N = p(19),
        k = function (m) {
          ...
          return y.formats = function (c) {}, y.prototype.format = function (c, o) {
      ...
      function k(n, s, A) {
        ...
        var v = m(n, s);
        return b && v.unshift([N, b]), w && v.push([N, w]), u(v), A != null && (v = r(v, A)), v = i(v), v
      }
      ...
      function m(n, s) {
        ...
        ], n.length > s.length && (A[0][0] = A[2][0] = p), A;
      ...
      function y(n, s) {
        for (var A = n.length, g = s.length, b = Math.ceil((A + g) / 2), w = b, v = 2 * b, h = new Array(v), d = new Array(v), E = 0; E < v; E++) h[E] = -1, d[E] = -1;
        h[w + 1] = 0, d[w + 1] = 0;
        for (var T = A - g, q = T % 2 != 0, D = 0, C = 0, Z = 0, I = 0, R = 0; R < b; R++) {
          for (var O = -R + D; O <= R - C; O += 2) {
            ...
            for (var F = L - O; L < A && F < g && n.charAt(L) == s.charAt(F);) L++, F++;
            if (h[S] = L, L > A) C += 2;
            else if (F > g) D += 2;
            else if (q) {
              var M = w + T - O;
      ...
      function o(n, s) {
        ...
        for (var A = 0, g = Math.min(n.length, s.length), b = g, w = 0; A < b;) n.substring(w, b) == s.substring(w, b) ? (A = b, w = A) : g = b, b = Math.floor((g - A) / 2 + A);
        return b
      }

      function t(n, s) {
        if (!n || !s || n.charAt(n.length - 1) != s.charAt(s.length - 1)) return 0;
        for (var A = 0, g = Math.min(n.length, s.length), b = g, w = 0; A < b;) n.substring(n.length - b, n.length - w) == s.substring(s.length - b, s.length - w) ? (A = b, w = A) : g = b, b = Math.floor((g - A) / 2 + A);
        return b
      }
      ...
      function e(n, s) {
        ...
        function b(C, Z, I) {
          for (var R = C.substring(I, I + Math.floor(C.length / 4)), O = -1, S = "", L, F, M, x;
            (O = Z.indexOf(R, O + 1)) != -1;) {
      ...
      function u(n) {
        n.push([N, ""]);
        for (var s = 0, A = 0, g = 0, b = "", w = "", v; s < n.length;) switch (n[s][0]) {
          case P:
            g++, w += n[s][1], s++;
            break;
          case p:
            ...
            break;
          case N:
            A + g > 1 ? (A !== 0 && g !== 0 && (v = o(w, b), v !== 0 && (s - A - g > 0 && n[s - A - g - 1][0] == N ? n[s - A - g - 1][1] += w.substring(0, v) : (n.splice(0, 0, [N, w.substring(0, v)]), s++), w = w.substring(v), b = b.substring(v)), v = t(w, b), v !== 0 && (n[s][1] = w.substring(w.length - v) + n[s][1], w = w.substring(0, w.length - v), b = b.substring(0, b.length - v))), A === 0 ? n.splice(s - g, A + g, [P, w]) : g === 0 ? n.splice(s - A, A + g, [p, b]) : n.splice(s - A - g, A + g, [p, b], [P, w]), s = s - A - g + (A ? 1 : 0) + (g ? 1 : 0) + 1) : s !== 0 && n[s - 1][0] == N ? (n[s - 1][1] += n[s][1], n.splice(s, 1)) : s++, g = 0, A = 0, b = "", w = "";
            break
        }
        n[n.length - 1][1] === "" && n.pop();
        var h = !1;
        for (s = 1; s < n.length - 1;) n[s - 1][0] == N && n[s + 1][0] == N && (n[s][1].substring(n[s][1].length - n[s - 1][1].length) == n[s - 1][1] ? (n[s][1] = n[s - 1][1] + n[s][1].substring(0, n[s][1].length - n[s - 1][1].length), n[s + 1][1] = n[s - 1][1] + n[s + 1][1], n.splice(s - 1, 1), h = !0) : n[s][1].substring(0, n[s + 1][1].length) == n[s + 1][1] && (n[s - 1][1] += n[s + 1][1], n[s][1] = n[s][1].substring(n[s + 1][1].length) + n[s + 1][1], n.splice(s + 1, 1), h = !0)), s++;
        h && u(n)
      }
      var l = k;
      ...
      function r(n, s) {
        ...
        if (w == null) return n;
        if (w[0] !== N) return n;
        if (v != null && w[1] + v[1] === v[1] + w[1]) return g.splice(b, 2, v, w), f(g, b, 2);
      ...
      function i(n) {
        for (var s = !1, A = function (v) {
            return v.charCodeAt(0) >= 56320 && v.charCodeAt(0) <= 57343
          }, g = function (v) {
            return v.charCodeAt(v.length - 1) >= 55296 && v.charCodeAt(v.length - 1) <= 56319
          }, b = 2; b < n.length; b += 1) n[b - 2][0] === N && g(n[b - 2][1]) && n[b - 1][0] === p && A(n[b - 1][1]) && n[b][0] === P && A(n[b][1]) && (s = !0, n[b - 1][1] = n[b - 2][1].slice(-1) + n[b - 1][1], n[b][1] = n[b - 2][1].slice(-1) + n[b][1], n[b - 2][1] = n[b - 2][1].slice(0, -1));
        if (!s) return n;
        for (var w = [], b = 0; b < n.length; b += 1) n[b][1].length > 0 && w.push(n[b]);
        return w
      }
      ...
      m.prototype.eventNames = function () {
        ...
        if (r.fn) {
          ...
          var s = r.length,
            A;
          for (n = 0; n < s; n++) switch (r[n].once && this.removeListener(c, r[n].fn, void 0, !0), i) {
            case 1:
            ...
            default:
              if (!f)
                for (A = 1, f = new Array(i - 1); A < i; A++) f[A - 1] = arguments[A];
        ...
        if (!o) return --this._eventsCount === 0 ? this._events = new N : delete this._events[u], this;
        var l = this._events[u];
        if (l.fn) l.fn === o && (!e || l.once) && (!t || l.context === t) && (--this._eventsCount === 0 ? this._events = new N : delete this._events[u]);
        else {
      ...
      var C = (0, r.default)("quill:clipboard"),
        ...
        O = [n.AlignStyle, s.BackgroundStyle, b.ColorStyle, w.DirectionStyle, v.FontStyle, h.SizeStyle].reduce(function (z, K) {
          return z[K.keyName] = K, z
        }, {}),
        S = function (z) {
          D(K, z);
...
`) && it.ops[it.ops.length - 1].attributes == null && (it = it.compose(new o.default().retain(it.length() - 1).delete(1))), C.log("convert", this.container.innerHTML, it), this.container.innerHTML = "", it
            ...
            value: function (G, W) {
              ...
              if (typeof G == "string") this.quill.setContents(this.convert(G), W), this.quill.setSelection(0, l.default.sources.SILENT);
              else {
...
`)) return K;
        for (var G = -1, W = z.parentNode; !W.classList.contains("ql-clipboard");)(e.default.query(W) || {}).blotName === "list" && (G += 1), W = W.parentNode;
        return G <= 0 ? K : K.compose(new o.default().retain(K.length() - 1).retain(1, {
          indent: G
        }))
      }
...
`)
      ...
      var A = (0, u.default)("quill:toolbar"),
        g = function (h) {
          ...
          function d(E, T) {
            ...
            } else typeof q.options.container == "string" ? q.container = document.querySelector(q.options.container) : q.container = q.options.container;
      ...
      var g = [
        ...
        b = function (v) {
          ...
          return k(h, [{
            key: "extendToolbar",
            value: function (E) {
              E.container.classList.add("ql-snow"), this.buildButtons([].slice.call(E.container.querySelectorAll("button")), i.default), this.buildPickers([].slice.call(E.container.querySelectorAll("select")), i.default), this.tooltip = new w(this.quill, this.options.bounds), E.container.querySelector(".ql-link") && this.quill.keyboard.addBinding({
                key: "K",
                shortKey: !0
              }, function (T, q) {
      ...
      function r(n, s) {
        ...
        }), s && (Object.setPrototypeOf ? Object.setPrototypeOf(n, s) : n.__proto__ = s)
      }
      var i = function (n) {
        r(s, n);
      ...
      var f = function (n) {
        r(s, n), P(s, null, [{
          ...
          value: function (g) {
            var b = g === "ordered" ? "OL" : "UL",
              w = N(s.__proto__ || Object.getPrototypeOf(s), "create", this).call(this, b);
        ...
        return P(s, [{
          ...
          key: "insertBefore",
          value: function (g, b) {
            if (g instanceof i) N(s.prototype.__proto__ || Object.getPrototypeOf(s.prototype), "insertBefore", this).call(this, g, b);
            else {
      ...
      function i(A, g) {
        ...
        }), g && (Object.setPrototypeOf ? Object.setPrototypeOf(A, g) : A.__proto__ = g)
      }
      var f = function (A) {
        i(g, A);
        ...
        return P(g, [{
          ...
          value: function (w) {
            ...
            this.cachedText !== v && ((v.trim().length > 0 || this.cachedText == null) && (this.domNode.innerHTML = w(v), this.domNode.normalize(), this.attach()), this.cachedText = v)
          }
        }]), g
      }(u.default);
      ...
      var n = new m.default.Attributor.Class("token", "hljs", {
        ...
        s = function (A) {
          ...
          function g(b, w) {
            a(this, g);
            var v = r(this, (g.__proto__ || Object.getPrototypeOf(g)).call(this, b, w));
            if (typeof v.options.highlight != "function") throw new Error("Syntax module requires highlight.js. Please include the library on the page before Quill.");
            var h = null;
            return v.quill.on(c.default.events.SCROLL_OPTIMIZE, function () {
          ...
          return P(g, [{
            ...
            value: function () {
              ...
              if (!this.quill.selection.composing) {
                ...
                }), this.quill.update(c.default.sources.SILENT), v != null && this.quill.setSelection(v, c.default.sources.SILENT)
              }
            }
          }]), g
        }(t.default);
      ...
      function f(g, b) {
        ...
        }), b && (Object.setPrototypeOf ? Object.setPrototypeOf(g, b) : g.__proto__ = b)
      }
      var n = [
          ["bold", "italic", "link"],
          [{
        ...
        s = function (g) {
          ...
          function b(w, v) {
            r(this, b), v.modules.toolbar != null && v.modules.toolbar.container == null && (v.modules.toolbar.container = n);
            var h = i(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this, w, v));
            return h.quill.container.classList.add("ql-bubble"), h
          }
          return N(b, [{
            key: "extendToolbar",
            value: function (v) {
              this.tooltip = new A(this.quill, this.options.bounds), this.tooltip.root.appendChild(v.container), this.buildButtons([].slice.call(v.container.querySelectorAll("button")), l.default), this.buildPickers([].slice.call(v.container.querySelectorAll("select")), l.default)
            }
          }]), b
        }(t.default);
      ...
      var A = function (g) {
        ...
        return N(b, [{
          ...
          key: "position",
          value: function (v) {
            var h = P(b.prototype.__proto__ || Object.getPrototypeOf(b.prototype), "position", this).call(this, v),
