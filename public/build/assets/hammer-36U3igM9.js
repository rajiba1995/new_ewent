...
`;
    ...
    function ce(t, e) {
      ...
      e.overallVelocityX = v.x, e.overallVelocityY = v.y, e.overallVelocity = S(v.x) > S(v.y) ? v.x : v.y, e.scale = a ? pe(a.pointers, r) : 1, e.rotation = a ? ve(a.pointers, r) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length, fe(i, e);
      var y = t.element;
    ...
    T(nt, E, {
      ...
      directionTest: function (t) {
        var e = this.options,
          ...
          s = t.deltaX,
          a = t.deltaY;
        return n & e.direction || (e.direction & I ? (n = s === 0 ? Q : s < 0 ? X : F, i = s != this.pX, r = Math.abs(t.deltaX)) : (n = a === 0 ? Q : a < 0 ? V : W, i = a != this.pY, r = Math.abs(t.deltaY))), t.direction = n, i && r > e.threshold && n & e.direction
      },
      attrTest: function (t) {
    ...
    T(mt, O, {
      ...
      process: function (t) {
        ...
        else if (t.eventType & f) this.reset(), this._timer = ot(function () {
    ...
    T(st, O, {
      ...
      process: function (t) {
        ...
        if (r && n && i) {
          ...
          if (h === 0) return this.hasRequireFailures() ? (this._timer = ot(function () {
            this.state = N, this.tryEmit()
          }, e.interval, this), m) : N
        }
        return _
    ...
    function It(t, e) {
      this.options = g({}, A.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = he(this), this.touchAction = new Tt(this, this.options.touchAction), Jt(this, !0), P(this.options.recognizers, function (i) {
    ...
    xe.Hammer = A, typeof l == "function" && l.amd ? l(function () {
      return A
    }) : _t.exports ? _t.exports = A : u[Qt] = A
